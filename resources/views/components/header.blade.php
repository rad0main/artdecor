<header class="w-full bg-white sticky top-0 z-50">
    ...
    <div class="relative">
        <div class="max-w-page mx-auto px-4">
            <div class="flex items-center justify-between h-10 lg:h-11">
                {{-- Левая часть --}}
                <div class="flex items-center gap-2 sm:gap-3 text-xs lg:text-xs">
        ...
        <div class="border-t border-gray-200" style="margin: 0 calc(50% + 90px) 0 0;"></div>
    </div>

    {{-- Строка логотипа (пересекает обе линии) --}}
    <div class="relative flex justify-center -mt-[1px]">
        <div class="bg-white px-3 relative z-10">
            <a href="{{ route('home') }}" class="block">
                <img src="{{ asset('logo.svg') }}" alt="ArtDecor" width="130" height="130" class="h-[100px] lg:h-[130px] w-auto">
            </a>
        </div>
    </div>
    ...
    <div class="relative">
        ...
        <div class="border-t border-gray-200" style="margin: 0 0 0 calc(50% + 90px);"></div>
